...
#
#     if folder == 'adt2gex/':
#         mod1_train, mod1_reducer = embedding(train_mod1.X, 8, random_seed=17)
#         pk.dump(mod1_reducer, open(f'{path_pretrain + folder}mod1 reducer 8.pkl', "wb"))
...
#         mod2_train, mod2_reducer = embedding(train_mod2.X, 8, random_seed=17)
#         pk.dump(mod2_reducer, open(f'{path_pretrain + folder}mod2 reducer 8.pkl', "wb"))
#     # else:
#     #     mod1_train, mod1_reducer = embedding(train_mod1.X, 256, random_seed=17)
#     #     pk.dump(mod1_reducer, open(f'{path_pretrain + folder}mod1 reducer.pkl', "wb"))
#     #     mod2_train, mod2_reducer = embedding(train_mod2.X, 256, random_seed=17)
