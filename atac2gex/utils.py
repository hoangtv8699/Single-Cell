...
class SimpleNET(torch.nn.Module):
    def __init__(self, input_dims, out_dims):
        ...
        self.linear.append(nn.Linear(input_dims, 1024))
        self.linear.append(nn.Linear(1024, 1024))
        self.linear.append(nn.Linear(1024, 1024))
        self.linear.append(nn.Linear(1024, out_dims))
...
def train_simple(train_loader, val_loader, net, args, logger, time_train):
    net.cuda()
